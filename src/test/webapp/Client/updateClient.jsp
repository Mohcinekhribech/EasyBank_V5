...
<div class="flex ">
    ...
    <main class="all mx-4 w-full h-screen overflow-auto ">
        <center class="mt-20">
            <div id="updateModal" class="h-screen flex center top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative w-full m-auto max-w-2xl max-h-full">
                    ...
                    <div class="relative p-8 bg-white rounded-lg ">
                        ...
                        <!-- Modal body -->
                        <form action="/update" method="post" class="p-2">
                            <input type="hidden" name="code" value="<c:out value="${client.code}"/>" />
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" value="<c:out value="${client.adresse}"/>" name="adresse" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" value="<c:out value="${client.nom}"/>" name="nom" id="floating_first_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" value="<c:out value="${client.prenom}"/>" name="prenom" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="tel" value="<c:out value="${client.telephone}"/>" pattern="[0-9]{10}" name="telephone" id="floating_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="date" name="datenaissance" value="<c:out value="${client.datenaissance}"/>" id="floating_repeat_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
