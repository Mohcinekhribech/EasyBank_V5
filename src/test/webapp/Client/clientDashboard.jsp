                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 flex space-x-2">
                            <a href="/delete?id=<c:out value="${client.code}"/>" class="hover:text-red-800 ">
                            ...
                            <a href="/edit?id=<c:out value="${client.code}"/>" class="hover:text-blue-600 ">
        ...
        <div id="addModal" class="fixed hidden backdrop-brightness-50  h-screen flex center top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full m-auto max-w-2xl max-h-full">
                ...
                <div class="relative p-8 bg-white rounded-lg ">
                    ...
                    <!-- Modal body -->
                    <form action="/insert" method="post" class="p-2">
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="code" id="floating" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] peer" placeholder=" " required />
                                <label for="floating" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#79489f] peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Code</label>
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="adresse" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                                <label for="floating_password" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#79489f] peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">adresse</label>
                            </div>
                        </div>
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
