...
<section class="flex ">
    <div id="sideBar"
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <div>
                <a href="?p=Dashboard&pd=commands"
    ...
    <main class="all mx-4 w-full h-screen overflow-auto ">
        <center class="mt-20">
            <form action="list" method="post" class="my-4 w-[50%]">
                <label
                ...
                <div class="relative">
                    ...
                    <input type="search" name="attribut"
                           class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="Search ..."/>
                    <button type="submit"
                            class="text-white absolute right-2.5 bottom-2.5 bg-[#7E52A0] hover:bg-[#79489f] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                </div>
            </form>
        </center>
        <div class="m-2">
            <div>
                <button class="addBtn" type="submit"
                        class="text-white bg-[#7E52A0] hover:bg-[#79489f] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-2 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        <th scope="row"
                            ...
                            <c:out value="${employe.nom}"/> <c:out value="${employe.prenom}"/>
                        </th>
                        <td class="px-6 py-4">
                            <c:out value="${employe.datenaissance}"/>
                        </td>
                        <td class="px-6 py-4">
                            <c:out value="${employe.datederecrutement}"/>
                        </td>
                        <td class="px-6 py-4">
                            <c:out value="${employe.telephone}"/>
                        </td>
                        <td class="px-6 py-4">
                            <c:out value="${employe.adresseemail}"/>
                        </td>
                        <td class="px-6 py-4">
                            <c:out value="${employe.matricule}"/>
                        </td>
                        <td class="px-6 py-4 flex space-x-2">
                            <a href="/delete?id=<c:out value="${employe.matricule}"/>" class="hover:text-red-800 ">
                            ...
                            <a href="/edit?id=<c:out value="${employe.matricule}"/>" class="hover:text-blue-600 ">
        ...
        <!-- Add modal -->
        <div id="addModal" class="fixed hidden backdrop-brightness-50  h-screen flex center top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full m-auto max-w-2xl max-h-full">
                ...
                <div class="relative p-8 bg-white rounded-lg ">
                    ...
                    <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                        ...
                        <button id="closeModel" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="defaultModal">
                    ...
                    <form action="/insertEmploye" method="post" class="p-2">
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="matricule" id="floating" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="email" name="adresseemail" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="nom" id="floating_first_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="prenom" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="tel" pattern="[0-9]{10}" name="telephone" id="floating_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="date" name="datenaissance" id="floating_repeat_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] focus:outline-none peer" placeholder=" " required />
                                <label for="floating_repeat_password" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#79489f] peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">date de naissance</label>
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="date" name="datederecrutement" id="floatingDate" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-[#7E52A0] focus:outline-none focus:ring-0 focus:border-[#79489f] peer" placeholder=" " required />
                                <label for="floatingDate" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#79489f] peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">date de recrutement</label>
                            </div>
                        </div>

                        <button type="submit" class="text-white bg-[#7E52A0] hover:bg-[#79489f]  focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                    </form>
