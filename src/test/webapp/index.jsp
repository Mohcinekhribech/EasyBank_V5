...
<section class="img flex flex-col items-center justify-center gap-16 ">
 <div class="text-6xl font-bold text-white text-center  opacity-100 flex flex-col items-center justify-center ">
   Simplify Your Banking Experience with <span class="text-black">EasyBank</span>
 </div>
  <div class="bg-white rounded-lg shadow-lg drop-shadow-lg  w-[40vw] h-[25vh] p-4">
    Welcome to <span class="text-[#29274C] text-xl font-semibold">EasyBank</span> , where we are committed to providing you with exceptional banking services. As your trusted financial partner, we strive to simplify your banking experience and empower your financial growth. With a focus on security, convenience, and personalized solutions, we offer a comprehensive range of services tailored to meet your unique needs. Whether you're looking for seamless online banking, competitive loan options, or expert financial advice, <span class="text-[#29274C] text-xl font-semibold">EasyBank</span> is here to guide you every step of the way. Discover a new era of banking excellence and embark on a journey towards financial prosperity with <span class="text-[#29274C]  font-semibold">EasyBank</span>.  </div>

    <button class="b mx-auto h-16 w-64 flex justify-center items-center">
...
<%--      need to fix this button--%>
      <a href="/simuler"  class="text-center text-white font-semibold z-10 pointer-events-none">Simuler un Crédit </a>
    </button>
  ...
  <section class="bg-white">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
      ...
      <p class="mt-8 text-base leading-6 text-center text-gray-400">
        © 2023 Achchaimae Mouhcine, Inc. All rights reserved.
      </p>
    </div>
  </section>
</section>
