                ...
                <c:forEach var="credit" items="${listCredit}">
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 flex space-x-2">
                            <a href="/acceptCredit?id=<c:out value="${credit.numero}"/>&code=<c:out value="${credit.client.code}"/>" class="hover:text-red-800 ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-check" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path d="M5 12l5 5l10 -10"></path>
                                </svg>
                            </a>
                            <a href="/refuseCredit?id=<c:out value="${credit.numero}"/>&code=<c:out value="${credit.client.code}"/>" class="hover:text-red-800 ">
                            ...
                            <a href="/historical?id=<c:out value="${credit.numero}"/>">
